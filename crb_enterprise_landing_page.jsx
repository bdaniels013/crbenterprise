    ...
    <div className="min-h-screen bg-[#FAF7F2] text-[#0f3d2e] flex flex-col">
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-6 pb-20">
        <section className="grid md:grid-cols-[minmax(0,3fr)_minmax(0,2.5fr)] gap-10 md:gap-16 items-start mt-4 md:mt-10">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-[#0f3d2e]/30 px-3 py-1 text-[11px] uppercase tracking-[0.2em] mb-4">
            ...
            <p className="text-[15px] md:text-base max-w-xl mb-8">
            ...
            <div className="rounded-xl border border-[#0f3d2e]/25 bg-white p-5 max-w-md shadow-sm">
              <div className="mb-2">
              ...
              <button
                ...
                disabled={loading}
                className="w-full rounded-full bg-[#D4AF37] text-[#0f3d2e] text-xs font-semibold py-3 hover:brightness-110 active:brightness-95 transition"
              >
          ...
          <div className="relative">
            <div className="rounded-[2rem] border border-[#0f3d2e]/25 bg-white p-4 md:p-5 flex flex-col gap-4 shadow-sm">
              <div className="grid grid-cols-2 gap-3">
                <img src="/chuck-standing.jpg" alt="Chuck standing" className="w-full h-64 md:h-72 object-cover rounded-2xl border border-[#0f3d2e]/25" />
                <img src="/chuck-sitting.jpg" alt="Chuck sitting" className="w-full h-64 md:h-72 object-cover rounded-2xl border border-[#0f3d2e]/25" />
              </div>
        ...
        <section className="mt-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="rounded-xl border border-[#0f3d2e]/25 bg-white p-4">
      ...
      <footer className="border-t border-[#0f3d2e]/25 py-6 text-[12px]">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 rounded-full border border-[#0f3d2e]/25 flex items-center justify-center text-[10px] font-semibold">CRB</div>
