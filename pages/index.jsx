  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative">
        ...
        <main className="container-wide mx-auto px-6 pb-20">
          <section className="grid md:grid-cols-[minmax(0,3fr)_minmax(0,2.5fr)] gap-10 md:gap-16 items-start mt-6">
            <div>
              ...
              <ul className="grid sm:grid-cols-2 gap-x-10 gap-y-3 text-[12px] mb-10">
          ...
          <section className="mt-16">
            ...
            <div className="space-y-4 max-w-3xl">
              <div className="rounded-xl border border-crbGreen/20 bg-white p-4"><p className="text-sm font-semibold mb-1">Is the $100 extra?</p><p className="text-[12px]">No. It applies to your package.</p></div>
              <div className="rounded-xl border border-crbGreen/20 bg-white p-4"><p className="text-sm font-semibold mb-1">What if I don’t move forward?</p><p className="text-[12px]">You still get a full strategy call.</p></div>
              <div className="rounded-xl border border-crbGreen/20 bg-white p-4"><p className="text-sm font-semibold mb-1">How long is the call?</p><p className="text-[12px]">Typically 60 minutes.</p></div>
              <div className="rounded-xl border border-crbGreen/20 bg-white p-4"><p className="text-sm font-semibold mb-1">Rescheduling policy</p><p className="text-[12px]">Please provide 24 hours’ notice.</p></div>
            </div>
          </section>
        </main>

        <footer className="border-t border-crbGreen/20 py-6 text-[12px]">
          <div className="container-wide mx-auto px-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div className="flex items-center gap-2"><div className="h-8 w-8 rounded-full border border-crbGreen/20 flex items-center justify-center text-[10px] font-semibold">CRB</div><span>© {new Date().getFullYear()} CRB Enterprise</span></div>
